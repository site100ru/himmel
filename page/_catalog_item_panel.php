...
use common\models\PanelFile;

/* @var $this yii\web\View */
?>
<div class="swiper-slide preview__item s<?= ArrayHelper::getValue($model, 'order'); ?>">
    <div class="item__wrapper">
        <div class="swiper-lazy item__param item__param-img" data-background="<?= ArrayHelper::getValue($model->imageUrls, PanelFile::TYPE_PREVIEW); ?>"></div>
        <div class="item__content bg-wood">
            ...
            <div class="item__param item__param-art">
                ...
                <ul class="item__param-list text-left">
                    <li><?= Yii::t('hm', 'Длина'); ?>: <span class="item-length"><?= ArrayHelper::getValue($model, 'length'); ?></span>&nbsp;<?= Yii::t('hm', 'мм'); ?></li>
