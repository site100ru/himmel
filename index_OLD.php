...
$this->title = 'Himmel — кубообразные потолки в Москве, Санкт-Петербурге и по всей России. Производство кубообразной рейки.';
?>
<div id="fullpage" class="fullpage-wrapper content-layer">
            ...
            <div class="sec__content">
                <div class="row justify-content-center no-gutters">
                    <div class="col-10 col-sm-10 col-lg-9 col-xxl-7">
                        <h2 class="mb-sm-4 text-center text-sm-left"><?= Yii::t('hm', '<span class="text-wood">Дизайнерские</span> потолочные&nbsp;и стеновые конструкции'); ?></h2>
            ...
            <div class="sec__content flex-fill d-flex">
                ...
                <div class="align-self-stretch flex-fill position-relative content__inner">
                    <div class="content__sm content__sm-reika d-md-none">
                        <h4 class="text-uppercase mb-2"><?= Yii::t('hm', 'Реечные потолки'); ?></h4>
                        <p><?= Yii::t('hm', 'Металлическая кубообразная рейка применяется для потолочных и стеновых конструкций.'); ?></p>
                    ...
                    <div id="popup-reika" class="content__overhead content__overhead-reika d-md-block">
                        ...
                        <div class="content__title d-none d-md-block mb-2">Himmel</div>
                        <h2 class="mb-4 mb-lg-6"><?= Yii::t('hm', 'Реечные потолки'); ?></h2>
                        <ul class="content__ul content__ul-styled mb-4 mb-lg-5">
                            <li><?= Yii::t('hm', 'Металлическая кубообразная рейка применяется для потолочных и стеновых конструкций.'); ?></li>
                        ...
                        <a href="<?= Url::to(['page/reika']); ?>" class="btn__base btn__base-wood _section__btn-page" data-ajax_method="GET" data-backdrop tabindex="-1" title="<?= Yii::t('hm', 'Смотреть типы реек'); ?>"><?= Yii::t('hm', 'Смотреть типы реек'); ?><span class="btn__icon"><svg><use xlink:href="#ico__arrow-1-w"></use></svg></span></a>
        ...
        <div class="sec__inner d-flex flex-column flex-wrap justify-content-center">
            <div class="sec__content d-flex flex-wrap justify-content-center">
                    ...
                    <div class="position-relative d-lg-flex d-xxl-block">
                        <div class="colors__tabs mb-4 mb-lg-0">
                            <ul class="list-group content__ul content__ul-nav content__ul-colors text-right text-uppercase text-nowrap d-flex justify-content-between flex-lg-column justify-content-lg-start" role="tablist">
                                <li><a href="#colors1" class="active show" data-toggle="tab" role="tab" title="<?= Yii::t('hm', 'Цвета в наличии'); ?>"><?= Yii::t('hm', '<span class="d-none d-lg-inline">Цвета </span>в наличии'); ?></a></li>
                ...
                <div class="section__right section__right-colors d-none d-xl-block">
                    <div class="content__title mb-2"><?= Yii::t('hm', 'Окрашивание'); ?></div>
                    <h2 class="mb-3"><?= Yii::t('hm', '<span class="text-wood">Цветовые</span> решения'); ?></h2>
                    <p><?= Yii::t('hm', 'В наличии всегда 15 цветов, имитирующих ценные <strong>породы дерева</strong> и 21 наиболее популярный цвет из набора <strong>RAL</strong>.'); ?>
            ...
            <div class="sec__content flex-fill d-flex">
                ...
                <div class="align-self-stretch flex-fill position-relative content__inner">
                    ...
                    <div id="popup-3dsys" class="content__overhead content__overhead-3dsys d-md-block">
                        ...
                        <div class="content__title d-none d-md-block mb-1">Himmel</div>
    ...
    <section class="section s7 section-videos" data-anchor="video-archive">
        <div class="sec__inner d-flex flex-column flex-wrap justify-content-center">
            <div class="sec__content d-flex flex-wrap justify-content-center">
                <div class="section__left section__left-videos">
                    <div class="content__title d-none d-xl-block mb-2"><?= Yii::t('hm', 'Видеоархив'); ?></div>
                    <h2 class="mb-6"><?= Yii::t('hm', '<span class="text-wood">Наглядно</span> о потолках'); ?></h2>
    ...
    <section class="section section__bg s8 section__projects inv" data-anchor="projects">
        <div class="sec__inner d-flex flex-column flex-wrap justify-content-center">
            <div class="sec__content d-flex flex-wrap justify-content-center">
                ...
                <div class="section__right section__right-projects d-none d-xl-block">
                    ...
                    <p class="mb-3"><?= Yii::t('hm', 'В этом разделе мы разместили фотографии объектов, в которых используется продукция Himmel. Надеемся, что эти материалы помогут вам получить более полное представление о продукции и возможностях нашей компании.'); ?></p>
    ...
    <section class="section s9 section-about" data-anchor="about">
        <div class="sec__inner d-flex flex-column flex-wrap justify-content-center">
            <div class="sec__content d-flex flex-wrap justify-content-center">
                ...
                <div class="section__left section__left-about d-flex flex-column justify-content-center">
                    ...
                    <h2 class="mb-3 mb-lg-4"><?= Yii::t('hm', 'Завод Himmel - это'); ?></h2>
                ...
                <div class="section__right section__right-about d-none d-md-flex flex-column justify-content-center position-relative">
                    <ul class="content__ul content__ul-files">
                        ...
                        <li><?= DocHelper::a('pozhar_g1', ['class' => 'font-weight-bold', 'target' => '_blank']); ?></li>
                        <li><?= DocHelper::a('protocol', ['class' => 'font-weight-bold', 'target' => '_blank']); ?></li>
    ...
    <section class="section s10 section-contacts inv" data-anchor="contacts">
        <div class="sec__inner d-flex flex-column flex-wrap justify-content-center">
            <div class="sec__content sec__content-contacts d-flex flex-wrap justify-content-center">
                <div class="section__left section__left-contacts">
                    ...
                    <ul class="content__ul content__ul-contacts">
                        <li class="address"><?= Yii::t('hm', '630005, Россия, г.&nbsp;Новосибирск, <strong class="pb-1 text-nowrap">ул. Промышленная, 4а</strong>, 2&nbsp;этаж'); ?></li>
                        ...
                        <li class="phone"><span class="text-nowrap"><a href="tel:8 (800) 700-63-62">8 (800) 700-63-62</a></span></li>
                        <li class="envelope"><a href="mailto:info@himmelrf.ru"><span class="text-nowrap">info@himmelrf.ru</span></a></li>
...
<div class="conrol-layer inv">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-6 text-center">
                <div class="text-left text-md-center">
                    <div class="navtop__logo"><svg><use xlink:href="#ico__logo"></use></svg></div>
                    <div class="navtop__phrase d-none d-md-block mt-2 text-center"><?= Yii::t('hm', 'завод потолочных конструкций'); ?></div>
                </div>
            </div>
                    ...
                    <div class="navtop-menu__wrapper">
                        <div class="navtop-menu__block">
                            ...
                            <ul class="navtop-menu__list text-left">
                                ...
                                <li data-menuanchor="reika"><a class="menu-link" href="#reika"><?= Yii::t('hm', 'Реечные потолки'); ?></a></li>
    ...
    <div class="callback-button">
        <div class="callback-button__inner"></div>
        <div class="callback-button__oouter"></div>
...
<div id="advert" class="advert _section__wrapper">
